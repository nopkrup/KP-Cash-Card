...
export default function App() {
  ...
  const calculate = () => {
    ...
    const discountAmount = a.totalValue - totalToPay;
    const discountPercent = ((discountAmount / a.totalValue) * 100).toFixed(2);

    const b = findBestCombo(price);
    const cashGap2 = price - b.totalValue;
    const totalToPay2 = b.totalPaid + cashGap2;
    const discountAmount2 = b.totalValue - totalToPay2;
    const discountPercent2 = ((discountAmount2 / b.totalValue) * 100).toFixed(2);
        ...
        {result && (
          <div>
            <div className="mt-6 border border-blue-200 rounded-lg p-4 bg-blue-50">
              ...
              <p className="font-bold text-red-600 text-xl mt-2">💰 รวมลูกค้าต้องจ่าย: {result.totalToPay.toLocaleString()} บาท</p>
            ...
            <div className="mt-6 border border-blue-300 rounded-lg p-4 bg-blue-100">
              ...
              <p className="font-bold text-red-600 text-xl mt-2">💰 รวมลูกค้าต้องจ่าย: {result.totalToPay2.toLocaleString()} บาท</p>
